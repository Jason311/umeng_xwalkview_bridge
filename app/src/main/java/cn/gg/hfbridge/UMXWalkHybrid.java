...
public class UMXWalkHybrid {
    ...
    private static class Holder {
        private static final UMXWalkHybrid INSTANCE = new UMXWalkHybrid();
    }

    private UMXWalkHybrid() {
    }
    ...
    public static UMXWalkHybrid getInstance(Context context) {
        if (context != null) {
    ...
    public void execute(final String url, final XWalkView webView) throws Exception {
        ...
        if (url.startsWith("umeng")) {
            ...
            if (functionName.equals("getDeviceId")) {
                ...
                Class<UMXWalkHybrid> classType = UMXWalkHybrid.class;
    ...
    private void getDeviceId(JSONArray args, XWalkView webView) {
        ...
        try {
            ...
            webView.load("javascript:" + callBack + "('" + deviceId + "')", null);
        } catch (Exception e) {
            e.toString();
        }
    }
